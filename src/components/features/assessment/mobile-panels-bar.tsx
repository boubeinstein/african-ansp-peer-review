...
export function MobilePanelsBar({
  ...
  return (
    <>
      {/* Fixed bottom bar on mobile/tablet - hidden on xl+ screens */}
      <div className="xl:hidden fixed bottom-0 left-0 right-0 z-40 border-t bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80">
