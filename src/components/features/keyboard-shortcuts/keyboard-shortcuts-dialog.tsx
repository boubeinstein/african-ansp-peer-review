  ...
  const shortcutGroups: ShortcutGroup[] = [
    ...
    },
    {
      ...
      shortcuts: [
        ...
        { keys: ["G", "→", "I"], label: t("navigation.programmeIntelligence") },
        { keys: ["G", "→", "A"], label: t("navigation.questionnairesAssessments") },
        { keys: ["G", "→", "R"], label: t("navigation.reviews") },
        { keys: ["G", "→", "K"], label: t("navigation.knowledgeBase") },
        { keys: ["G", "→", "V"], label: t("navigation.reviewerPool") },
        { keys: ["G", "→", "T"], label: t("navigation.training") },
