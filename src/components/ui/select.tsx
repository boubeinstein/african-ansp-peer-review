...
/**
 * SelectTrigger with enhanced focus states for WCAG 2.1 AA compliance
 */
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:border-primary",
