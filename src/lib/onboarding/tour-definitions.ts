 ...
 *
 * Updated to align with the restructured 8+3 sidebar navigation.
 */
...
export const anspStaffTour: TourDefinition = {
  ...
  steps: [
    ...
    {
      id: "questionnaires-assessments",
      targetSelector: "[data-tour='nav-questionnairesAssessments']",
      titleKey: "onboarding.questionnairesAssessments.title",
      descriptionKey: "onboarding.questionnairesAssessments.description",
      placement: "right",
      route: "/assessments",
    },
    {
      id: "peer-reviews",
      targetSelector: "[data-tour='nav-peerReviews']",
    ...
    {
      id: "knowledge-base",
      targetSelector: "[data-tour='nav-knowledgeBase']",
      titleKey: "onboarding.knowledgeBase.title",
      descriptionKey: "onboarding.knowledgeBase.description",
      placement: "right",
      route: "/knowledge",
    },
    {
...
export const peerReviewerTour: TourDefinition = {
  ...
  steps: [
    ...
    {
      id: "reviewer-pool",
      targetSelector: "[data-tour='nav-reviewerPool']",
      titleKey: "onboarding.reviewerPool.title",
      descriptionKey: "onboarding.reviewerPool.description",
      placement: "right",
      route: "/reviewers",
    },
    {
...
export const coordinatorTour: TourDefinition = {
  ...
  steps: [
    ...
    {
      id: "programme-intelligence",
      targetSelector: "[data-tour='nav-programmeIntelligence']",
      titleKey: "onboarding.programmeIntelligence.title",
      descriptionKey: "onboarding.programmeIntelligence.description",
      placement: "right",
      route: "/analytics",
    },
    {
    ...
    {
      id: "organizations",
      targetSelector: "[data-tour='nav-organizationsMembership']",
