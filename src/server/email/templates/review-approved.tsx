...
const content = {
  ...
  fr: {
    subject: (ref: string) => `Demande d'évaluation approuvée - ${ref}`,
    preview: (org: string) => `Bonne nouvelle ! La demande d'évaluation par les pairs pour ${org} a été approuvée`,
    greeting: (name: string) => `Cher/Chère ${name},`,
    intro:
      "Nous avons le plaisir de vous informer que votre demande d'évaluation par les pairs a été approuvée. Votre organisation est maintenant programmée pour participer au Programme Africain d'Évaluation par les Pairs des ANSP.",
    ...
    viewReview: "Voir les détails de l'évaluation",
    note: "Notre équipe de coordination vous contactera prochainement pour confirmer les dates de l'évaluation et discuter du processus de préparation.",
    closing: "Merci de votre engagement à améliorer la sécurité aérienne grâce à l'évaluation par les pairs.",
...
export const defaultNextSteps = {
  ...
  fr: [
    "La constitution de l'équipe d'évaluation commencera prochainement",
    "Vous recevrez les exigences de documentation pré-évaluation",
    "Une réunion de lancement sera programmée avec l'équipe d'évaluation",
