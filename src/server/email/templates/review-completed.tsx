...
const content = {
  ...
  fr: {
    subject: (ref: string) => `Examen par les pairs terminé - ${ref}`,
    preview: (org: string) => `L'examen par les pairs de ${org} est terminé`,
    greeting: (name: string) => `Cher/Chère ${name},`,
    intro: (org: string) =>
      `Nous avons le plaisir de vous informer que l'examen par les pairs de ${org} est terminé. Merci de votre participation et de votre coopération tout au long du processus d'examen.`,
    completionBadge: "EXAMEN TERMINÉ",
    details: "Résumé de l'examen",
    reference: "Référence de l'examen",
    organization: "Organisation",
    reviewDates: "Période d'examen",
    ...
    reportSection: "Rapport d'examen",
    reportAvailable:
      "Le rapport d'examen est maintenant disponible. Veuillez l'examiner attentivement et traiter toutes les constatations nécessitant une action corrective.",
    reportPending:
      "Le rapport d'examen est en cours de finalisation et sera disponible prochainement. Vous recevrez une notification lorsqu'il sera prêt.",
    ...
    acknowledgment:
      "Nous tenons à reconnaître l'engagement et le professionnalisme démontrés par votre équipe lors de cet examen. Votre ouverture et votre engagement ont contribué de manière significative au succès de cet examen par les pairs.",
    support:
      "L'équipe d'examen reste disponible pour fournir des éclaircissements sur les constatations ou pour vous aider à développer vos plans d'action corrective.",
    closing:
